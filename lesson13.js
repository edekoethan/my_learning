...
/*
  ...
  console.time('Regular forloop')
  for (let i = 0; i < countries_ex3.length; i++){
console.log(countries_ex3[i][0], countries_ex3[i][1])
  }
  console.timeEnd("Regular forloop")

  console.time('for of loop')
for (const [name, city] of countries_ex3) {
  console.log(name, city)
}
console.timeEnd('for of loop')

console.time('forEach loop')
countries_ex3.forEach(([name, city]) => {
  console.log(name, city)
})
...
for (let i = 0; i <= 10; i +=1 ){
    let errorMessage = `${1} is not even`
    console.log('the # is ' + 1)
...
const ex5_countries = [
  ...
  console.group('kingdoms')
  console.table(ex5_countries)
  console.groupEnd()

  console.group('tech_teachers')
  console.table(user)
  console.groupEnd()

  console.group('tech_students')
  console.table(users)
  console.groupEnd()
  */

  //console.assert( 10 <! 2 * 10)
  //console.warn("Get out of my server")
  //console.error('Failed to reconnect with wifi')

  /*
  console.time('forloop')
  let tech_income = [200, 300, 400, 700, 2000]
function findIncomeSum(array){
  let sum = 0
...
findIncomeSum(tech_income)
console.timeEnd('forloop')


console.time('for of')
let tech_income2 = [200, 300, 400, 700, 2000]
function findIncomeSum(array){
//let sum = 0
for (sum of array){
...
findIncomeSum(tech_income2)
console.timeEnd('for of')

console.time('forEach');
let tech_income3 = [200, 300, 400, 700, 2000];
