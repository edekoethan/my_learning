...
/*
  function mostSpokenLanguages(countries, n){
    ...
    const topNLanguages = sortedLanguages.slice(0, n);
    const result = topNLanguages.map(language => {
      const countriesSpoken = countries.filter(country => country.languages.includes(language)).length;
      return { language, countriesSpoken };
    });
    return result;
  }
  
  console.log(mostSpokenLanguages(task_countries, 10));
  */